...
<head>
  ...
  function otherSelected(obj) {
    if(obj.value == "Others") {
        document.getElementById('div').innerHTML = ' <br> <h5> Enter the event here: </h5> <input type="text" name="amount" />';
    }else{
...
<center>NoticeBoard</center>
      ...
      <div id="div"></div>
			...
			<div class="input-group">
			<label><center>Venue</center></label>
			<center> 
